...
//    onThemeChanged(dApp->viewerTheme->getCurrentTheme());
    ...
    connect(m_player, SIGNAL(sigUpdatePanelName(QString)),
            this, SLOT(onUpdatePanelName(QString)));
...
void SlideShowPanel::onUpdatePanelName(QString name)
{
#ifdef OPENACCESSIBLE
    setObjectName(name);
...
#ifdef OPENACCESSIBLE
    setObjectName(vinfo.path);
    setAccessibleName(vinfo.path);
#endif
