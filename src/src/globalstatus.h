...
public:
    ...
    // 当前编辑会话是否包含未保存修改
    Q_PROPERTY(bool editModified READ editModified WRITE setEditModified NOTIFY editModifiedChanged)
    bool editModified() const;
    void setEditModified(bool value);
    Q_SIGNAL void editModifiedChanged();
...
private:
    ...
    bool storeEditMode = false;
    bool storeEditModified = false;
