...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到看圖 ![viewer](../common/deepin_image_viewer.svg) 單擊運行。
...
- 在任務欄右鍵單擊 ![viewer](../common/deepin_image_viewer.svg)，選擇 **關閉所有** 來退出看圖。
- 在看圖界面單擊 ![icon_menu](../common/icon_menu.svg)，選擇 **退出** 來退出看圖。

### 查看快捷鍵

在看圖界面上，按下鍵盤上的按下鍵盤上的 **Ctrl + Shift + ?** 組合鍵來查看快捷鍵。
...
> ![notes](../common/notes.svg)說明：當使用觸控螢幕電腦時，二指張開，放大圖片；二指捏合，縮小圖片。
...
1. 在看圖界面上，單擊工具欄上的按鈕 ![adaptimage](../common/adaptimage.svg) 或滾動鼠標放大圖片且當圖片超出界面範圍時，界面上會出現導航窗口。
2. 拖動導航窗口內的方框，查看該區域的訊息。
3. 單擊導航窗口上的按鈕 **x** 或在右鍵菜單中選擇 **隱藏導航窗口** 來關閉導航窗口。
...
- 單擊看圖界面上的 ![delete_press](../common/delete.svg) 圖標。
- 右鍵單擊圖片，選擇 **刪除**。
- 在看圖界面上，按下鍵盤的 **Delete** 鍵。
