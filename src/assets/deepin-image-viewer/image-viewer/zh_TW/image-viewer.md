...
- 在看圖介面單擊 ![icon_menu](../common/icon_menu.svg)，選擇 **離開** 關閉看圖。
...
1. 在看圖介面，單擊工具列上的按鈕 ![ocr](../common/ocr.svg) 或右鍵單擊圖片，選擇 **識別文字**。

2. 進入圖文識別視窗，識別圖片中的文字，圖片越清晰簡潔，識別越準確。

3. 在識別文字介面右下角，單擊複製按鈕 ![copy](../common/copy.svg) 將識別到的文字內容複製到剪貼簿；單擊下載按鈕 ![copy](../common/download.svg) 將識別到的文字內容儲存為TXT文件。
