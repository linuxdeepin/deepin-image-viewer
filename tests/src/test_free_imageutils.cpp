...
TEST_F(FreeImageUtilsTest, GetAllMetaData_ValidPngFile_ReturnsExpectedFields)
{
    ...
    EXPECT_EQ(got.value("DateTimeOriginal"), lastModified.toString("yyyy/MM/dd HH:mm:ss"));
    EXPECT_EQ(got.value("DateTimeDigitized"), lastModified.toString("yyyy/MM/dd HH:mm:ss"));
    EXPECT_TRUE(QDateTime::fromString(got.value("DateTimeOriginal"), "yyyy/MM/dd HH:mm:ss").isValid());
}
